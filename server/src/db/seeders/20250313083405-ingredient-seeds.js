  ...
  async up(queryInterface) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        { type: "Ром (светлый)", isAlko: true, imgUrl: "/ingredients/Ром (светлый).png" },
        { type: "Ром (темный)", isAlko: true, imgUrl: "/ingredients/Ром (темный).png" },
        { type: "Джин", isAlko: true, imgUrl: "/ingredients/Джин.png" },
        { type: "Водка", isAlko: true, imgUrl: "/ingredients/Водка.png" },
        { type: "Текила (бланко)", isAlko: true, imgUrl: "/ingredients/Текила (бланко).png" },
        { type: "Текила (репосадо)", isAlko: true, imgUrl: "/ingredients/Текила (репосадо).png" },
